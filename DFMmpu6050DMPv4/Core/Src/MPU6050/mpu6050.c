...
int setXAccelOffset(int16_t offset)
{
	i2c_write(devAddr, MPU6050_RA_XA_OFFS_H, offset, 0);
	return 0;
}

int setYAccelOffset(int16_t offset)
{
	i2c_write(devAddr, MPU6050_RA_YA_OFFS_H, offset, 0);
	return 0;
}

int setZAccelOffset(int16_t offset)
{
	i2c_write(devAddr, MPU6050_RA_ZA_OFFS_H, offset, 0);
	return 0;
}

int setXGyroOffset(int16_t offset)
{
	i2c_write(devAddr, MPU6050_RA_XG_OFFS_USRH, offset, 0);
	return 0;
}

int setYGyroOffset(int16_t offset)
{
	i2c_write(devAddr, MPU6050_RA_YG_OFFS_USRH, offset, 0);
	return 0;
}

int setZGyroOffset(int16_t offset)
{
	i2c_write(devAddr, MPU6050_RA_ZG_OFFS_USRH, offset, 0);
	return 0;
}
//------------------End of File----------------------------
